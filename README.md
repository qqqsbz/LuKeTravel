...
<ul>免责声明,该项目只限于学习、交流，不能作为任何商业用途，版权归客路所有,如果该项目涉及到侵权,烦请联系下我,我将删除本项目.谢谢~  联系方式：932170917@qq.com。
    <br/>
...
<li>FDFullscreenPopGesture : 手势返回</li>
</ul></li>
<li>目录结构分析
...
<li>App     		 : 项目根路径</li>
<li>Home             : 首页</li>
<li>Destionation     : 目的地</li>
<li>Order            : 订单信息</li>
<li>Mine             : 我的</li>
<li>Kits             : 第三方库</li>
<li>Facility         : 通用view</li>
<li>ScreenShot       : 应用截图</li>
</ul><li>
</li>后续工作
